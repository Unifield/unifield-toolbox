...
'''%(row[0], row[0], row[5].lower(), ttype.get(row[3].lower(), row[3].lower()), toxml(row[1]), row[2] and 'ref="msf_chart_of_account.%s"'%row[2] or '', row[6] == 'VRAI' and 'True' or 'False', acctype[row[4]] ))
