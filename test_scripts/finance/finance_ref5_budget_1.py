...
try:
#  o.read('msf.budget', [budget_id], [])
#  o.read('msf.budget.line', l_ids, ['budget_amount', 'actual_amount', 'comm_amount', 'balance', 'percentage'])
  print o.get('account.analytic.account').search([('parent_id', 'child_of', 16)])
except Exception, e:
  print e
finally:
